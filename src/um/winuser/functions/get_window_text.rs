...
/// # use winresult::*;
/// # use std::ptr::*;
/// let hwnd = unsafe { create_window_ex_w(0, abistr::utf16ish!("Message"), abistr::utf16ish!("Title"), 0, 0, 0, 0, 0, HWnd::MESSAGE, null_mut(), None, null_mut()) }.unwrap();
...
/// assert_eq!(abistr::utf16ish!("Title").to_units(), title);
/// #
