use crate::*;
use abistr::{AsCStr, encoding::Utf16ish};
...
/// # use hwnd::*;
/// # use winresult::*;
/// let wm1 = register_window_message_w(abistr::utf16ish!("WM_EXAMPLE")).unwrap();
/// let wm2 = register_window_message_w(abistr::utf16ish!("WM_EXAMPLE")).unwrap();
/// assert_eq!(wm1, wm2);
///
/// // ...leak tons of IDs...
...
/// #   let wm_name = abistr::CStrNonNull::<abistr::encoding::Utf16ish>::from_units_with_nul(&wm_name).unwrap();
/// #   let _ = register_window_message_w(wm_name);
/// # }
///
/// assert_eq!(ERROR::NOT_ENOUGH_MEMORY, register_window_message_w(abistr::utf16ish!("WM_EXAMPLE2")).unwrap_err());
/// ```
pub fn register_window_message_w(string: impl abistr::TryIntoAsCStr<Utf16ish>) -> Result<WM32, Error> {
