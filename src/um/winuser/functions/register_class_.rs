...
///     class_name: Some(abistr::utf16ish!("my_unicode_class")),
///     .. Default::default()
/// };
///
...
///     class_name: Some(abistr::utf16ish!("my_unicode_class_ex")),
///     .. Default::default()
/// };
///
...
/// # use std::ptr::*;
/// #
/// let class_name = abistr::utf16ish!("my_unicode_temp_class");
/// let wndclass = WndClassW {
...
/// ### See Also
/// *   [About Window Classes](https://learn.microsoft.com/en-us/windows/win32/winmsg/about-window-classes)
pub unsafe fn unregister_class_w<'t>(class_name: impl Into<NameAtomOrZero<'t, Utf16ish>>, hinstance: impl Into<HInstance<'t>>) -> Result<(), Error> {
